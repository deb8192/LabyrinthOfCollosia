...
#ifdef LABYRINTHOFCOLLOSIA_TlocStateManager_generated_h
#error "TlocStateManager.generated.h already included, missing '#pragma once' in TlocStateManager.h"
#endif
...
#define LabyrinthOfCollosia_Source_LabyrinthOfCollosia_Public_GameState_TlocStateManager_h_13_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(LABYRINTHOFCOLLOSIA_API, UTlocStateManager); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UTlocStateManager); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	LABYRINTHOFCOLLOSIA_API UTlocStateManager(UTlocStateManager&&); \
	LABYRINTHOFCOLLOSIA_API UTlocStateManager(const UTlocStateManager&); \
public:
...
public: \
	DECLARE_CLASS(UTlocStateManager, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/LabyrinthOfCollosia"), LABYRINTHOFCOLLOSIA_API) \
...
public: \
	typedef UTlocStateManager UClassType; \
	typedef ITlocStateManager ThisClass; \
